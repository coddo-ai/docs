...
description: "Talk to Claude Code or Codex through a rich visual interface with streaming, diffs, and more."
icon: "message"
---
...
<Frame>
  ![Chat view showing tool use and todo blocks](/images/coddo-task-flow.png)
</Frame>
