...
If you don't have a `CLAUDE.md` file yet, or if you want to start fresh, click the **Regenerate** button. Coddo will analyze your project's codebase and automatically generate a complete `CLAUDE.md` tailored to your project - including the tech stack, file structure, conventions, and build commands.
