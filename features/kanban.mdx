...
- **Instruction** - Detailed description of what Claude Code should do, with a **rich text editor** supporting bold, italic, code, and lists. You can also **dictate** the instruction with the mic button — see [Voice Dictation](/features/voice-dictation)
